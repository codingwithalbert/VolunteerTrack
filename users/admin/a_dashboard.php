...
<body>
    ...
    <div class="container">
        <div class="welcome">
            ...
            <p>Manage the entire VolunteerTrack system</p>
        </div>
        ...
        <div class="quick-actions">
            <a href="modules/users/manage_users.php" class="action-btn">
            ...
            <a href="modules/users/add_user.php" class="action-btn">
                <div style="font-size: 32px;">➕</div>
                <h4>Add User</h4>
            </a>
        ...
        <div class="recent-section">
            ...
            <?php if (count($recent_hours) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p style="color: #666; text-align: center; padding: 20px;">No recent submissions</p>
            <?php endif; ?>
        </div>
    </div>
</body>
